...
public class AddContactsPageTest extends BaseTest {
    ...
    @Test(description = "Verify that first name is shown in list of contacts")
    ...
    @Test(description = "Verify that last name is shown in list of contacts")
    ...
    @Test(description = "Verify that only first name and last name of contact are shown in contacts list")
